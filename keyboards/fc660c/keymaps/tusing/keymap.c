...
// Press Fn+Backspace to swap between OG keymap and custom keymap
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = KEYMAP(
        KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,   TO(2),     KC_INS,
        _______,KC_VOLD,KC_MUTE,KC_VOLU,_______,_______,_______,_______,KC_PSCR,KC_SLCK,KC_PAUS,_______,_______,_______,     KC_DEL,
        _______,AUD_PRV,AUD_PLY,AUD_NXT,_______,_______,_______,_______,KC_HOME,KC_PGUP,_______,_______,     _______,
        KC_CAPS,_______,_______,_______,_______,_______,_______,_______,KC_END, KC_PGDN,KC_TILD,_______,     KC_PGUP,
  ...
  [3] = KEYMAP(
        KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12,    TO(0),     _______,
